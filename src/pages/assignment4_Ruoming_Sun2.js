...
const Charts = () => {
    ...
    const [hoveredStation, setHoveredStation] = React.useState(null); // New hover state hook
            ...
            <Row className='justify-content-md-center'>
                <Col>
                    <svg width={WIDTH} height={HEIGHT}>
                        ...
                        height={innerHeightScatter} width={innerWidth} hoveredStation={hoveredStation} setHoveredStation={setHoveredStation} 
                ...
                <Col>
                    <svg width={WIDTH} height={HEIGHT}>
                        ...
                        yScale={yScaleBar} height={innerHeightBar} width={innerWidth} hoveredStation={hoveredStation} setHoveredStation={setHoveredStation}/>
                    </svg>
                </Col>
            </Row>
